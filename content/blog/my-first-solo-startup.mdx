...
ogImage: "/blogs/my-solo-startup-og.png"
---
...
**Braintree** has its own hosted pages for subscription management, which would have been nice, but since they didn't respond, that was out.

Eventually I had to go with **BOG**, and it was the worst experience I had during the entire development process. 
Their API was pretty much pointless, and a lot of things weren't documented properly. 
For monthly subscriptions, I had to handle everything manually, which was annoying.

Since **BOG** doesn't have hosted pages, I had to build the entire subscription management UI myself. 
